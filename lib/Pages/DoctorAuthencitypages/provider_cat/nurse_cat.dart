...
class Nurse_cat extends StatefulWidget {
  final String phone;

  const Nurse_cat({Key? key, required this.phone}) : super(key: key);

  @override
  _Nurse_catState createState() => _Nurse_catState(phone);
}

class _Nurse_catState extends State<Nurse_cat> {
